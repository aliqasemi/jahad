...
class StepFilter extends AbstractFilter
{

    public static function build(Request $request, array $filters, $mapFilter = null): StepFilter
    {
        return new StepFilter($request, $filters, $mapFilter);
    }
